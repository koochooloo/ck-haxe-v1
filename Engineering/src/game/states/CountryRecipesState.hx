...
import game.ui.states.CountryRecipesMenu;


class CountryRecipesState extends SpeckBaseState
{
	private var m_menu:CountryRecipesMenu;
	
	public function new() 
	{
		super( GameState.COUNTRYRECIPES );
	}
