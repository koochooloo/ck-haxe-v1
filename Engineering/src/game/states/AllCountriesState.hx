...
import game.ui.states.AllCountriesMenu;


class AllCountriesState extends SpeckBaseState
{
	private var m_menu:AllCountriesMenu;
	
	public function new() 
	{
		super( GameState.ALLCOUNTRIES );
	}
