...
class Parser {
  ...
  public static function checkResult<A>( result : ParseResult<A> ) : ParseResult<A> {
  	 if ( result == null ) {
	    throw result;
	 }	 
	 return result;
  ...
  **/
  public static function index() : ParseObject<Int> {
    return function(stream : String, i : Int = 0) : ParseResult<Int> {
      return checkResult( ParseUtil.makeSuccess(i, i) );
    };
  }
  ...
  **/
  public static function any() : ParseObject<String> {
    return function(stream : String, i : Int = 0) : ParseResult<String> {
      return checkResult( i >= stream.length
  ...
  **/
  public static function all() : ParseObject<String> {
    return function(stream : String, i : Int = 0) : ParseResult<String> {
      return checkResult( ParseUtil.makeSuccess(stream.length, stream.substring(i)) );
    };
  }
  ...
  **/
  public static function string(string : String) : ParseObject<String> {
    ...
    return function(stream : String, i : Int = 0) : ParseResult<String> {
      ...
      if (head == string) {
        return checkResult( ParseUtil.makeSuccess(i+len, head) );
      } else {
        return checkResult( ParseUtil.makeFailure(i, expected) );
      }
    };
  }
    ...
    return function(stream : String, i : Int = 0) : ParseResult<String> {
      ...
      if (match) {
        ...
        if (groupMatch != null && pos.pos == 0) {
          return checkResult( ParseUtil.makeSuccess(i + pos.len, groupMatch) );
        }
      }
  ...
  **/
  public static function succeed<A>(value : A) : ParseObject<A> {
    return function(stream : String, i : Int = 0) : ParseResult<A> {
      return checkResult( ParseUtil.makeSuccess(i, value) );
    };
  }
  ...
  public static function seq<A>(parsers : Array<ParseObject<A>>) : ParseObject<Array<A>> {
    ...
    return function(stream : String, i : Int = 0) : ParseResult<Array<A>> {
      ...
      for (parser in parsers) {
        ...
        if (!result.status) return checkResult( cast(result) );
        accum.push(result.value);
        i = result.index;
      }

      return checkResult( ParseUtil.mergeReplies(ParseUtil.makeSuccess(i, accum), result) );
    };
  }
  ...
  **/
  public static function alt<A>(parsers : Array<ParseObject<A>>) : ParseObject<A> {
    ...
    return function(stream : String, i : Int = 0) : ParseResult<A> {
      ...
      for (parser in parsers) {
        result = ParseUtil.mergeReplies(parser.apply(stream, i), result);
        if (result.status) return checkResult( result );
      }
  ...
  **/
  public static function test(predicate : String -> Bool) : ParseObject<String> {
    return function(stream : String, i : Int = 0) : ParseResult<String> {
      ...
      return checkResult( i < stream.length && predicate(char)
  ...
  **/
  public static function takeWhile(predicate : String -> Bool) : ParseObject<String> {
    return function(stream : String, i : Int = 0) : ParseResult<String> {
      ...
      return checkResult( ParseUtil.makeSuccess(j, stream.substring(i, j)) );
    };
  }
  ...
  **/
  public static function flatMap<A, B>(parser: ParseObject<A>, fun : A -> ParseObject<B>) : ParseObject<B> {
    return function(stream : String, i : Int = 0) : ParseResult<B> {
      ...
      return checkResult( ParseUtil.mergeReplies(nextParseObject.apply(stream, result.index), result) );
    };
  }
  ...
  **/
  public static function map<A, B>(parser: ParseObject<A>, fun : A -> B) : ParseObject<B> {
    return function(stream : String, i : Int = 0) : ParseResult<B> {
      var result = parser.apply(stream, i);
      if (!result.status) return checkResult( cast(result) );
      return checkResult( ParseUtil.mergeReplies(ParseUtil.makeSuccess(result.index, fun(result.value)), result) );
    };
  }
    ...
    return function(stream : String, i : Int = 0) : ParseResult<Array<A>> {
      ...
      for (times in 0...min) {
        ...
        if (result.status) {
          i = result.index;
          accum.push(result.value);
        } else return checkResult( cast(prevParseResult) );
      }
      ...
      return checkResult( ParseUtil.mergeReplies(ParseUtil.makeSuccess(i, accum), prevParseResult) );
    };
  }
  ...
  **/
  public static function lazy<A>(fun : Void -> ParseObject<A>) : ParseObject<A> {
    ...
    return parser = function(stream : String, i : Int = 0) : ParseResult<A> {
      return checkResult( (parser.apply = fun().apply)(stream, i) );
    };
  }
