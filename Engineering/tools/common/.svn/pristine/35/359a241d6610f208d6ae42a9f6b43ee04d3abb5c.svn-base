...
call :installset lime 2.0.1
IF %ERRORLEVEL% NEQ 0 GOTO :error

call :installset hxtools 1.1.6
IF %ERRORLEVEL% NEQ 0 GOTO :error

call :installset openfl 2.1.7
IF %ERRORLEVEL% NEQ 0 GOTO :error
...
call :installset actuate 1.7.5
IF %ERRORLEVEL% NEQ 0 GOTO :error

ECHO Installing additional basic libraries...
ECHO.

call :installset spritesheet 1.2.0
IF %ERRORLEVEL% NEQ 0 GOTO :error

call :installset svg 1.0.8
IF %ERRORLEVEL% NEQ 0 GOTO :error
