...
ECHO Installing html5 dependent libraries...
ECHO.

call :installset openfl-html5 1.4.2-beta
IF %ERRORLEVEL% NEQ 0 GOTO :error

call :installset openfl-html5-dom 1.2.2
IF %ERRORLEVEL% NEQ 0 GOTO :error

call :installset openfl-bitfive 1.4.3
IF %ERRORLEVEL% NEQ 0 GOTO :error
