...
ECHO Installing flash dependent libraries...
ECHO.

call :installset swf 1.7.0
IF %ERRORLEVEL% NEQ 0 GOTO :error

ECHO Installing flash support tools...
ECHO.

call :installset air3 0.0.1
IF %ERRORLEVEL% NEQ 0 GOTO :error

call :installset as3hx 1.0.1
IF %ERRORLEVEL% NEQ 0 GOTO :error
